...
class MutiChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=8):
        ...
        self.conv_1 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_2 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_3 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_4 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_5 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_6 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_7 = DepthWiseConv(in_planes, in_planes//8)
        self.conv_8 = DepthWiseConv(in_planes, in_planes//8)
        self.CA = ChannelAttention(in_planes//8)
        self.split_channel = in_planes//8
    ...
    def forward(self, x):
        ...
        feats = torch.cat((x1, x2, x3, x4, x5, x6, x7, x8),dim=1)
        ...
        x_ca = torch.cat((x1_ca, x2_ca, x3_ca, x4_ca, x5_ca, x6_ca, x7_ca, x8_ca),dim=1)

        attention_vectors = x_ca.view(batch_size, 8, self.split_channel, 1, 1)
