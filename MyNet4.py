...
class MutiChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=8):
        ...
        self.conv_1 = DepthWiseConv(in_planes, in_planes//2)
        self.conv_2 = DepthWiseConv(in_planes, in_planes//2)
        # self.conv_3 = DepthWiseConv(in_planes, in_planes//4)
        # self.conv_4 = DepthWiseConv(in_planes, in_planes//4)
        self.CA = ChannelAttention(in_planes//2)
        self.split_channel = in_planes//2
    ...
    def forward(self, x):
        ...
        x_ca = torch.cat((x1_ca, x2_ca),dim=1)

        attention_vectors = x_ca.view(batch_size, 2, self.split_channel, 1, 1)
